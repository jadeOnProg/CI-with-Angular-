				...
				<table class="table table-hover">
					...
					<tbody>
						<tr data-ng-repeat="employee in employees track by $index">
							<td>{{ $index + 1 }}</td>
							<td><input class="todo" type="text" ng-model-options="{ updateOn: 'blur' }" ng-change="updateTask(employees[$index])" ng-model="employees[$index].title"></td>
							<td style="text-align:center"><input class="todo" type="checkbox" ng-change="updateTask(employees[$index])"ng-model="employees[$index].status" ng-true-value="'1'" ng-false-value="'0'"></td>
